...
const initialMessages: Message[] = [
  {
    ...
    senderId: "contact",
    kind: "text",
    text: "Hola, vi su anuncio en Instagram. Tienen envío a CDMX?",
    imageUrl: "",
    time: "9:41",
  },
  {
    ...
    senderId: "brand",
    kind: "text",
    text: "Sí, enviamos a toda la República. Hoy tenemos entrega express en CDMX.",
    imageUrl: "",
    time: "9:42",
  },
  {
    ...
    senderId: "brand",
    kind: "image",
    text: "Este es el modelo más vendido.",
    imageUrl:
  ...
  },
  {
    ...
    senderId: "contact",
    kind: "text",
    text: "Me gusta. Cuánto cuesta en color arena?",
    imageUrl: "",
    time: "9:43",
  },
];
  ...
  function addMessage(kind: Message["kind"]) {
    ...
    setMessages((current) => [
      ...current,
      {
        ...
        kind,
        text: kind === "text" ? inputValue || "Nuevo mensaje" : "Nueva imagen",
        imageUrl:
          kind === "image"
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl space-y-2">
              ...
              <p className="text-sm text-slate-600 md:text-base">
                Create realistic WhatsApp iPhone conversations and export them
                as screenshots.
              </p>
            </div>
            <Button
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Control the top bar, contact details, and wallpaper.
                  </p>
                </div>
              </div>
                ...
                <Field label="Chat Date">
                  <Popover>
                    ...
                    >
                      ...
                      {format(chatDate, "EEE d MMM", { locale: es })}
                    </PopoverTrigger>
                  ...
                  >
                    <div className="mb-3 flex items-center gap-3">
                      ...
                      <p className="text-sm font-semibold text-slate-900">
                        {participant.id === contact.id ? "Contact" : "Brand"}
                      </p>
                    </div>
                    <div className="space-y-3">
                      ...
                      <Field label="Avatar Letter (fallback)">
                        <input
              ...
              <div className="mt-5 space-y-3">
                <p className="text-sm font-medium text-slate-800">Wallpaper</p>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
              <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Add text or image messages exactly in the order they should
                    appear.
                  </p>
                </div>
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-[180px_minmax(0,1fr)]">
                ...
                <Field label="Quick Text Draft">
                  <input
                    value={inputValue}
                    onChange={(event) => setInputValue(event.target.value)}
                    className={inputClasses}
                    placeholder="Escribe un mensaje base y luego ajusta cada burbuja abajo"
                  />
                </Field>
              </div>
